...
set ntrace [open ftpTelnet.tr w]
$ns trace-all $ntrace
set namfile [open ftpTelnet.nam w]
...
exec awk -f ftp.awk ftpTelnet.tr > temp1

exec awk -f telnet.awk ftpTelnet.tr > temp2

#Execute the nam animation file
exec nam ftpTelnet.nam &
exit 0
}
